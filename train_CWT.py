...
def main():
    ...
    parser.add_argument("--net_name", type = str, default="ViT-small-less-than-6",  help="Basic Name of this run with detailed network-architecture selection")
    parser.add_argument("--FL_platform", type = str, default="ViT-CWT", choices=["Swin-CWT", 'ViT-CWT',"ResNet-CWT", "Swin-CWT", "EfficientNet-CWT"],  help="Choose of different FL platform.")
    parser.add_argument("--dataset", choices=["cifar10", "Retina" ,"CelebA", "Retina"], default="cifar10", help="Which dataset.")
